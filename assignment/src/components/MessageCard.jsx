...
const MessageCard = () => {
  return (
    <div className="w-[60%] h-auto flex  items-end mt-4">
      <div className="text-white bg-green-300 flex items-end h-[10%] rounded-full justify-center text-center animate-spin p-1">
        <svg
          width="30"
          height="30"
          viewBox="0 0 15 15"
